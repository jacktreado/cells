...
const double initialCalA 		= 1.15;			// initial cal A parameter (before extension sim)
const double calA0max 			= 1.5;			// maximum asphercity parameter
...
int main(int argc, char const *argv[])
{
	...
	double a, sizeDisp, phiTarget, plThresh, dl0, kl, ka, kb, del, th0;
	...
	// set prefferred angle for all of the cells
	for (int ci=0; ci<NCELLS; ci++)
		packingObject.cell(ci).setc0Angle(th0);
